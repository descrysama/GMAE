...
$req = $bdd->prepare('SELECT nom FROM users where pseudo = ?');
            ...
            <div class="col-md-6 col-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="mutualistes.html" class="btn btn-primary">Voir plus</a>
                    </div>
                  </div>
            </div>
            <div class="col-md-6 col-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="allia.html" class="btn btn-primary">Voir plus</a>
                    </div>
                  </div>
            </div>
            <div class="col-md-6 col-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="assurisk.html" class="btn btn-primary">Voir plus</a>
                    </div>
                  </div>
            </div>
            <div class="col-md-6 col-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="ocar.html" class="btn btn-primary">Voir plus</a>
                    </div>
                  </div>
            </div>
        </div>
